...
// ---------------------------------------------------------------------------
// .link file parser (systemd.link(5))
// ---------------------------------------------------------------------------
...
/// All specified conditions must match for the file to apply.
#[derive(Debug, Clone, Default)]
...
/// `[Link]` section of a `.link` file — settings to apply.
#[derive(Debug, Clone, Default)]
...
///
/// Returns `None` if no `.link` file matches.
