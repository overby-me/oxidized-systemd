{
  name = "04-JOURNAL";
  # Passing subtests: cat, corrupted-journals, fss, invocation, journal-corrupt, reload, stopped-socket-activation
  ...
  testEnv.TEST_MATCH_SUBTEST = "[.]cat[.]|corrupted-journals|fss|invocation|journal-corrupt|reload|stopped-socket";
}
