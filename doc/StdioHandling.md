...
This document gives a overview of how stdio filedesscriptors are passed around in systemd-rs
...
Currently the output of services is just printed on stdout/err of systemd-rs with a prefix that
